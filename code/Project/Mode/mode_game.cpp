...
void CMode_Game::Init(void) {
	...
	Manager::BlockMgr()->MoveBlockCreate(D3DXVECTOR3(0.0f, 100.0f, 0.0f), D3DXVECTOR3(0.2f, 0.0f, 0.0f),100.0f);
...
void CMode_Game::Update(void) {
	...
	static float f = 0.0f;
	f += 0.01f;
	RNLib::Text2D()->Put(D3DXVECTOR2(320.0f, 80.0f), f, "てすとテストＴＥＳＴ", CText::ALIGNMENT::CENTER, 0);
	//RNLib::Text3D()->Put(D3DXVECTOR3(0.0f, 80.0f, 0.0f), INITD3DXVECTOR3, "てすとテストＴＥＳＴ", CText::ALIGNMENT::CENTER, 0);
}
